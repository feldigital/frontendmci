  ...
  crearFormulario() {
    this.nuevoForm = this.fb.group
      ({
        ...
        fecNacimiento: [new Date().toISOString().split('T')[0]],
        sexo: [''],
        direccion: [''],
        barrio: [''],
        ...
        estadoCivil: [''],
        bautizado: [false],
        fechaBautismo: [new Date().toISOString().split('T')[0]],
        lider: [false],
        ...
        cdestino: [false],
        imgPerfil: [''],
        fechaUvida: [new Date().toISOString().split('T')[0]],
        fechaCdestino: [new Date().toISOString().split('T')[0]],
        citaBiblica: [''],
        textoBiblico: [''],
        pwd: [''],
